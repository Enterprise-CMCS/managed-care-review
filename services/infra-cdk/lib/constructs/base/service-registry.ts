...
export class ServiceRegistry {
    ...
    static putValue(
        ...
        const parameterName = ResourceNames.ssmParameterName(
            category,
            key,
            stage
        )
     ...
     */
    static putCloudFrontDistributionId(
        scope: Construct,
        stage: string,
        ...
        this.putValue(
            ...
            distributionId,
            stage,
            `CloudFront ${distributionType} distribution ID`
        )
    }
     ...
     */
    static getCloudFrontDistributionId(
        scope: Construct,
        stage: string,
        distributionType: string
    ): string {
