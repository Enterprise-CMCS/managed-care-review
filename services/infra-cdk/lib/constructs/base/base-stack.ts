...
import { Stack, Tags, Aspects } from 'aws-cdk-lib'
import type { Construct } from 'constructs'
import { AwsSolutionsChecks } from 'cdk-nag'
import { MANDATORY_TAGS, PROJECT_NAME, ResourceNames } from '@config/constants'
...
export abstract class BaseStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props: BaseStackProps) {
        const stackName =
            ResourceNames.stackName(props.serviceName, props.stage) + '-cdk'
        ...
        super(scope, id, {
            ...
            description:
                props.description ||
                `${PROJECT_NAME} - ${props.serviceName} stack for ${props.stage}`,
            env: {
