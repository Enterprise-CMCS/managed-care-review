...
import type { SecurityConfig } from '@config/stage-config'
...
export class CognitoAuth extends Construct {
    ...
    constructor(scope: Construct, id: string, props: CognitoAuthProps) {
        ...
        this.userPool = new cognito.UserPool(this, 'UserPool', {
            userPoolName: ResourceNames.resourceName(
                props.userPoolName,
                'user-pool',
                props.stage
            ),
                ...
                supportedIdentityProviders: this.samlProvider
                    ? [
                          ...
                          cognito.UserPoolClientIdentityProvider.custom(
                              this.samlProvider.providerName
                          ),
                      ]
                    : [cognito.UserPoolClientIdentityProvider.COGNITO],
    ...
    private addSamlProvider(
        ...
        return new cognito.UserPoolIdentityProviderSaml(this, 'SamlProvider', {
            ...
            attributeMapping: {
                ...
                custom: {
                    'custom:state_code':
                        cognito.ProviderAttribute.other('stateCode'),
    ...
    private createIdentityPool(props: CognitoAuthProps): void {
        ...
        this.identityPool = new cognito.CfnIdentityPool(this, 'IdentityPool', {
            identityPoolName: ResourceNames.resourceName(
        ...
        this.authenticatedRole = new iam.Role(this, 'AuthenticatedRole', {
            ...
            roleName: ResourceNames.resourceName(
                props.identityPoolName!,
                'authenticated-role',
                props.stage
            ),
    ...
    private storeInParameterStore(stage: string): void {
        ...
        ServiceRegistry.putUserPoolClientId(
            this,
            stage,
        ...
        if (this.identityPool) {
            ServiceRegistry.putIdentityPoolId(
                this,
                stage,
                this.identityPool.ref
            )
