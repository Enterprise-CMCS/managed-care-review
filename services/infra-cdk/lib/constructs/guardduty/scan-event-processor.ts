...
export class ScanEventProcessor extends Construct {
    ...
    constructor(scope: Construct, id: string, props: ScanEventProcessorProps) {
        ...
        this.scanResultProcessor = new BaseLambdaFunction(
            this,
            'ScanResultProcessor',
            {
                ...
                environment:
                    LambdaEnvironmentFactory.createVirusScanEnvironment(
                        ...
                        [
                            ...
                            props.qaBucket.bucketName,
                        ],
                        {
                            maxFileSize: FILE_SIZE_LIMITS.MAX_SCAN_SIZE_BYTES,
                            enableClamAvCompatibility:
                                props.enableClamAvCompatibility !== false,
    ...
    private grantPermissions(props: ScanEventProcessorProps): void {
        ...
        this.scanResultProcessor.function.addToRolePolicy(
    ...
    private createEventRules(props: ScanEventProcessorProps): void {
        ...
        this.scanCompleteRule.addTarget(
            new targets.LambdaFunction(this.scanResultProcessor.function)
        )
