...
import type * as waf from 'aws-cdk-lib/aws-wafv2'
...
export class WafProtectedApi extends Construct {
    ...
    constructor(scope: Construct, id: string, props: WafProtectedApiProps) {
        ...
        this.api = new apigateway.RestApi(this, 'Api', {
            restApiName: ResourceNames.resourceName(
                props.apiName,
                'api',
                props.stage
            ),
            description:
                props.description || `${props.apiName} API for ${props.stage}`,
        })
    ...
    private addGatewayResponses(): void {
        ...
        this.api.addGatewayResponse('BadRequestResponse', {
            ...
            templates: {
                'application/json':
                    '{"error": "Bad Request", "message": "$context.error.validationErrorString"}',
            },
        })
