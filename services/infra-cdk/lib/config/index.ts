/**
 * Ultra-Lean Config Index
 * Clean re-exports with zero bloat
 */
...
export type StageConfig = import('./environments').EnvironmentConfig;
...
export const validateEnvironment = (stage: string): void => { require('./environments').getEnvironment(stage); };
...
export function getLambdaEnvironment(stage: string, additionalEnv: Record<string, string> = {}): Record<string, string> {
  return {
    STAGE: stage,
