        ...
        switch (stage) {
            case 'dev':
                return {
                    ...
                    maxCapacity: 16,
                    backupRetentionDays:
                        DATABASE_DEFAULTS.BACKUP.RETENTION_DAYS.dev,
            ...
            case 'val':
                return {
                    ...
                    maxCapacity: 16,
                    backupRetentionDays:
                        DATABASE_DEFAULTS.BACKUP.RETENTION_DAYS.val,
            ...
            case 'prod':
                return {
                    ...
                    maxCapacity: 16,
                    backupRetentionDays:
                        DATABASE_DEFAULTS.BACKUP.RETENTION_DAYS.prod,
                    deletionProtection: true,
                    enableDataApi: false,
                    secretRotationDays: SECRETS_MANAGER_DEFAULTS.ROTATION_DAYS,
                }
    ...
    private static getMonitoringConfig(stage: string): MonitoringConfig {
        switch (stage) {
            case 'dev':
                return {
                    logRetentionDays:
                        CLOUDWATCH_DEFAULTS.LOG_RETENTION_BY_STAGE.dev,
            ...
            case 'val':
                return {
                    logRetentionDays:
                        CLOUDWATCH_DEFAULTS.LOG_RETENTION_BY_STAGE.val,
            ...
            case 'prod':
                return {
                    logRetentionDays:
                        CLOUDWATCH_DEFAULTS.LOG_RETENTION_BY_STAGE.prod,
                    detailedMetrics: true,
                    tracingEnabled: true,
                    dashboardEnabled: true,
                }
