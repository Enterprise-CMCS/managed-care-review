...
export class StackOrchestrator {
    ...
    private createFoundation(): FoundationStack {
        return new FoundationStack(
            this.props.app,
            ResourceNames.stackName('Foundation', this.props.stage),
            {
                env: this.props.env,
    ...
    private createNetwork(foundation: FoundationStack): NetworkStack {
        const stack = new NetworkStack(
            this.props.app,
            ResourceNames.stackName('Network', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
    ...
    private createLambdaLayers(network: NetworkStack): LambdaLayersStack {
        const stack = new LambdaLayersStack(
            this.props.app,
            ResourceNames.stackName('LambdaLayers', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
    ...
    private createData(network: NetworkStack): DataStack {
        ...
        const stack = new DataStack(
            this.props.app,
            ResourceNames.stackName('Data', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
    ...
    private createAuth(foundation: FoundationStack): AuthStack {
        ...
        try {
            ...
            if (
                ssmEmailValue &&
                !ssmEmailValue.includes('dummy-value') &&
                ssmEmailValue.trim() !== ''
            ) {
            ...
            console.log(
                'Email source address not found in SSM, will use default'
            )
        }

        const stack = new AuthStack(
            this.props.app,
            ResourceNames.stackName('Auth', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
    ...
    private createDatabaseOps(
        ...
        const stack = new DatabaseOperationsStack(
            this.props.app,
            ResourceNames.stackName('DatabaseOps', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
    ...
    private createFrontend(): FrontendStack {
        const stack = new FrontendStack(
            this.props.app,
            ResourceNames.stackName('Frontend', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
    ...
    private createVirusScanning(
        data: DataStack,
        network: NetworkStack
    ): GuardDutyMalwareProtectionStack {
        const stack = new GuardDutyMalwareProtectionStack(
            this.props.app,
            ResourceNames.stackName('VirusScanning', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
    ...
    private createMonitoring(foundation: FoundationStack): MonitoringStack {
        const stack = new MonitoringStack(
            this.props.app,
            ResourceNames.stackName('Monitoring', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
     ...
     */
    private createSharedInfra(
        lambdaLayers: LambdaLayersStack
    ): SharedInfraStack {
        const stack = new SharedInfraStack(
            this.props.app,
            ResourceNames.stackName('SharedInfra', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
    ...
    private createGraphQLApi(
        ...
        const stack = new GraphQLApiStack(
            this.props.app,
            ResourceNames.stackName('GraphQLApi', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
                ...
                databaseName: ResourceNames.databaseName(
                    this.props.stage,
    ...
    private createPublicApi(
        ...
        const stack = new PublicApiStack(
            this.props.app,
            ResourceNames.stackName('PublicApi', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
     ...
     */
    private createFileOps(
        data: DataStack,
        sharedInfra: SharedInfraStack
    ): FileOpsStack {
        const stack = new FileOpsStack(
            this.props.app,
            ResourceNames.stackName('FileOps', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
    ...
    private createScheduledTasks(
        ...
        const stack = new ScheduledTasksStack(
            this.props.app,
            ResourceNames.stackName('ScheduledTasks', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
    ...
    private createAuthExtensions(
        ...
        const stack = new AuthExtensionsStack(
            this.props.app,
            ResourceNames.stackName('AuthExtensions', this.props.stage),
            {
                env: this.props.env,
                stage: this.props.stage,
                stageConfig: this.props.config,
