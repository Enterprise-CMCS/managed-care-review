...
import { ImportedVpc, ServiceRegistry } from '@constructs/base';
import { stackName, resourceName } from '../config';
...
export class NetworkStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: NetworkStackProps) {
    super(scope, id, {
      ...props,
      stackName: stackName('Network', props.stage),
  ...
  private createSecurityGroups(): void {
    ...
    this.lambdaSecurityGroup = new ec2.SecurityGroup(this, 'LambdaSecurityGroup', {
      ...
      securityGroupName: resourceName('lambda', 'sg', this.stage)
    });
    ...
    this.databaseSecurityGroup = new ec2.SecurityGroup(this, 'DatabaseSecurityGroup', {
      ...
      securityGroupName: resourceName('database', 'sg', this.stage)
    });
  ...
  private importVpnSecurityGroups(): void {
    ...
    try {
      ...
      const vpnSecurityGroupId = ssm.StringParameter.valueFromLookup(
        this,
        '/configuration/vpn_security_group_id'
      );
    ...
    try {
      ...
      const sharedServicesGroupId = ssm.StringParameter.valueFromLookup(
        this,
        '/configuration/shared_services_security_group_id'
      );
