...
export function getOtelLayerArn(
...
this.layerVersion = new lambda.LayerVersion(this, 'PrismaLayer', {
    code: lambda.Code.fromAsset(
        path.join(
            __dirname,
            '../../../app-api/lambda-layers-prisma-client-engine'
        )
    ),
...
export class OtelLayer extends Construct {
    ...
    constructor(scope: Construct, id: string, props: OtelLayerProps) {
        ...
        const archType =
            architecture === Architecture.ARM_64 ? 'arm64' : 'x86_64'
...
environment: LambdaEnvironmentFactory.merge(
    ...
    LambdaEnvironmentFactory.createDatabaseEnvironment(
        secretArn,
        stage,
        region
    ),
...
;['GET', 'POST'].forEach((method) => {
    graphqlResource.addMethod(
        method,
        new apigateway.LambdaIntegration(graphqlFunction),
        {
...
const thirdPartyAuthorizer = new apigateway.TokenAuthorizer(
    this,
...
const rotatorFunction = new lambda.Function(this, 'RotatorFunction', {
    ...
    description:
        'Conducts an AWS SecretsManager secret rotation for RDS PostgreSQL',
    timeout: Duration.seconds(30),
    memorySize: 512,
    vpc: this.vpc,
...
export class AuthStack extends BaseStack {
    ...
    private createCognitoAuth(): void {
        const cognitoAuth = new CognitoAuth(this, 'Auth', {
            ...
            documentUploadsBucketArn: Fn.importValue(
                `uploads-${this.stage}-DocumentUploadsBucketArn`
            ),
            qaUploadsBucketArn: Fn.importValue(
                `uploads-${this.stage}-QAUploadsBucketArn`
            ),
    ...
    constructor(scope: Construct, id: string, props: CognitoAuthProps) {
        ...
        this.userPool = new cognito.UserPool(this, 'UserPool', {
            ...
            userInvitation: {
                ...
                emailBody:
                    'Hello {username}, your temporary password is {####}',
            },
            passwordPolicy: {
                minLength: 16,
            ...
            mfa:
                props.securityConfig.cognitoMfa === 'REQUIRED'
            ...
            customAttributes: {
                stateCode: new cognito.StringAttribute({
                    minLen: 2,
                    maxLen: 2,
                }),
        ...
        const samlProvider = new cognito.UserPoolIdentityProviderSaml(
            ...
            'OktaProvider',
            {
                ...
                metadata: {
                    metadataType:
                        cognito.UserPoolIdentityProviderSamlMetadataType.URL,
                ...
                CognitoAuthorizedPolicy: new iam.PolicyDocument({
                    statements: [
                        ...
                        new iam.PolicyStatement({
                            ...
                            resources: [
                                `arn:aws:execute-api:${Stack.of(this).region}:${Stack.of(this).account}:${props.apiGatewayRestApiId}/*`,
                            ],
                        }),
                        // S3 bucket access
                        new iam.PolicyStatement({
...
export class InfraApiStack extends BaseStack {
    ...
    private createMonitoringInfrastructure(): void {
        ...
        const failedDataBucket = new s3.Bucket(
            this,
            'FirehoseFailedDataBucket',
            {
    ...
    private exportApiGatewayValues(): void {
        ...
        ServiceRegistry.putApiRootResourceId(
            this,
            this.stage,
            this.api.restApiRootResourceId
        )
            ...
            rules: [
                {
                    ...
                    statement: {
                        rateBasedStatement: {
                            limit:
                                props.wafConfig.ipRateLimitPerFiveMinutes ||
                                2000,
                            aggregateKeyType: 'IP',
                        },
                    },
...
Conditions:
    ...
    CreateGitHubIdentityProvider:
        !Or # CDK: if (stage in ['main', 'val', 'prod'])
        - !Equals
          - ${sls:stage}
          - main
        - !Equals
...
export class AppWebDeploymentStack extends BaseStack {
    constructor(
        scope: Construct,
        id: string,
        props: AppWebDeploymentStackProps
    ) {
        super(scope, id, props)

        // Import references from other stacks
        const apiUrl = Fn.importValue(
            `infra-api-${this.stage}-ApiGatewayRestApiUrl`
        )
        const uiBucket = s3.Bucket.fromBucketName(
            this,
            'UiBucket',
            Fn.importValue(`ui-${this.stage}-S3BucketName`)
        )
        const storybookBucket = s3.Bucket.fromBucketName(
            this,
            'StorybookBucket',
            ...
            cloudfront.Distribution.fromDistributionAttributes(
                ...
                'UiDistribution',
                {
                    distributionId: Fn.importValue(
                        `ui-${this.stage}-CloudFrontDistributionId`
                    ),
                    domainName: Fn.importValue(
                        `ui-${this.stage}-CloudFrontEndpointUrl`
                    ),
                }
            )
        const storybookDistribution =
            cloudfront.Distribution.fromDistributionAttributes(
                this,
                'StorybookDistribution',
                {
                    distributionId: Fn.importValue(
                        `storybook-${this.stage}-CloudFrontDistributionId`
                    ),
                    domainName: Fn.importValue(
                        `storybook-${this.stage}-CloudFrontEndpointUrl`
                    ),
                }
            )
        ...
        this.createStorybookDeployment(
            storybookBucket,
            storybookDistribution,
            config
        )
    ...
    private getAppConfiguration(): AppConfig {
        ...
        const ldClientId = ssm.StringParameter.valueForStringParameter(
            this,
            '/configuration/react_app_ld_client_id_feds'
        )
        // ... other SSM parameters

        return {
            VITE_APP_AUTH_MODE: process.env.VITE_APP_AUTH_MODE || 'AWS_IAM',
            VITE_APP_API_URL: Fn.importValue(
                `infra-api-${this.stage}-ApiGatewayRestApiUrl`
            ),
            VITE_APP_APPLICATION_ENDPOINT: Fn.importValue(
                `ui-${this.stage}-CloudFrontEndpointUrl`
            ),
            VITE_APP_COGNITO_REGION: Stack.of(this).region,
            VITE_APP_COGNITO_ID_POOL_ID: Fn.importValue(
                `ui-auth-${this.stage}-IdentityPoolId`
            ),
            VITE_APP_COGNITO_USER_POOL_ID: Fn.importValue(
                `ui-auth-${this.stage}-UserPoolId`
            ),
            VITE_APP_COGNITO_USER_POOL_CLIENT_ID: Fn.importValue(
                `ui-auth-${this.stage}-UserPoolClientId`
            ),
            VITE_APP_COGNITO_USER_POOL_CLIENT_DOMAIN: Fn.importValue(
                `ui-auth-${this.stage}-UserPoolClientDomain`
            ),
            VITE_APP_S3_REGION: Stack.of(this).region,
            VITE_APP_S3_DOCUMENTS_BUCKET: Fn.importValue(
                `uploads-${this.stage}-DocumentUploadsBucketName`
            ),
            VITE_APP_S3_QA_BUCKET: Fn.importValue(
                `uploads-${this.stage}-QAUploadsBucketName`
            ),
...
export class AppWebCodeBuildStack extends BaseStack {
    constructor(
        scope: Construct,
        id: string,
        props: AppWebCodeBuildStackProps
    ) {
        super(scope, id, props)
        ...
        const buildProject = new codebuild.Project(this, 'AppWebBuildProject', {
            ...
            buildSpec: codebuild.BuildSpec.fromObject({
                ...
                phases: {
                    install: {
                        commands: ['cd services/app-web', 'npm ci'],
                    },
                    build: {
                        commands: ['npm run build', 'npm run storybook:build'],
                    },
                },
                artifacts: {
                    files: ['**/*'],
        ...
        const distribution = new cloudfront.Distribution(
            ...
            'StorybookDistribution',
            {
                ...
                minimumProtocolVersion:
                    cloudfront.SecurityPolicyProtocol.TLS_V1,
                defaultBehavior: {
                    ...
                    functionAssociations: [
                        {
                            ...
                            eventType:
                                cloudfront.FunctionEventType.VIEWER_RESPONSE,
                        },
                    ],
                },
                errorResponses: [
...
export function validateEnvironment(stage: string): void {
    const required = ['PROJECT', 'AWS_REGION', 'PERM_BOUNDARY_ARN', 'IAM_PATH']
...
export class IamPermissionsBoundaryAspect implements IAspect {
    ...
    public visit(node: IConstruct): void {
        ...
        if (cdk.CfnResource.isCfnResource(node)) {
            if (
                (node as cdk.CfnResource).cfnResourceType === 'AWS::IAM::Role'
            ) {
...
const healthCheck = ApiEndpointFactory.createPublicEndpoint(
    this,
    'HealthCheck',
    {
...
const userEndpoint = ApiEndpointFactory.createAuthenticatedEndpoint(
    this,
    'GetUser',
    {
...
// 3. GraphQL endpoint
const graphqlEndpoints = ApiEndpointFactory.createGraphQLEndpoint(
    this,
    'GraphQL',
    {
    ...
    constructor(scope: Construct, id: string, props: BaseLambdaFunctionProps) {
        ...
        this.function = new lambda.Function(this, 'Function', {
            ...
            reservedConcurrentExecutions:
                props.lambdaConfig.reservedConcurrentExecutions,
            vpc: props.vpc,
...
export class LambdaFactory extends Construct {
    ...
    public createFunction(
        ...
        const needsVpc =
            functionProps.useVpc ?? this.requiresVpc(functionProps.functionName)
        ...
        const lambdaConfig = {
            ...
            ...(functionProps.ephemeralStorageSize && {
                ephemeralStorageSize: functionProps.ephemeralStorageSize,
            }),
        }
        ...
        const lambdaFunction = new BaseLambdaFunction(this, functionId, {
            ...
            layers: [
                ...
                ...(needsPrismaLayer(functionProps.functionName) &&
                this.props.prismaLayer
                    ? [this.props.prismaLayer]
                    : []),
            ...
            logRetentionDays:
                this.props.stageConfig.monitoring.logRetentionDays,
        })
    ...
    public createDatabaseFunction(
        ...
        const environment =
            LambdaEnvironmentFactory.createDatabaseLambdaEnvironment(
                this.props.stage,
                this.props.region,
...
export class ServiceRegistry {
     ...
     */
    static importValue(scope: Construct, key: string): string {
        const stack = Stack.of(scope)
        const stage = stack.node.tryGetContext('stage') || 'dev'
...
export class ApiComputeStack extends BaseStack {
    constructor(scope: Construct, id: string, props: ApiComputeStackProps) {
        ...
        const uploadsBucketName = ServiceRegistry.getUploadsBucketName(
            this,
            this.stage
        )
                    ...
                    statement: {
                        notStatement: {
                            statement: {
                                geoMatchStatement: {
                                    countryCodes:
                                        config.geoRestriction.allowedCountries,
                                },
                            },
                        },
                    },
    ...
    private createBuildConfig(props: any): BuildConfig {
        return {
            ...
            VITE_APP_COGNITO_USER_POOL_CLIENT_ID:
                props.userPool.userPoolClientId,
...
export class CodeBuildFrontend extends Construct {
    ...
    constructor(
        ...
        this.project = new codebuild.Project(this, 'BuildProject', {
            ...
            environment: {
                buildImage: codebuild.LinuxBuildImage.STANDARD_7_0,
                computeType: codebuild.ComputeType.MEDIUM,
                environmentVariables: this.convertToCodeBuildEnv(
    ...
    private convertToCodeBuildEnv(env: { [key: string]: string }): {
    ...
    constructor(
        ...
        this.migrationFunction = new LambdaFactory.createDatabaseFunction(
            ...
            'MigrationFunction',
            {
                ...
                vpc: props.vpc,
                securityGroup:
                    props.databaseCluster.connections.securityGroups[0],
                ...
                environment: {
                    ...
                    PRISMA_SCHEMA_PATH:
                        '/opt/nodejs/node_modules/@prisma/client/schema.prisma',
                },
        ...
        props.databaseCluster.connections.allowDefaultPortFrom(
...
export const handler = async (event: CloudFormationCustomResourceEvent) => {
    ...
    try {
        ...
        const secret = await getSecretValue(
            process.env.DATABASE_URL_SECRET_ARN!
        )
        ...
        const count =
            await prisma.$executeRaw`SELECT COUNT(*) FROM "_prisma_migrations"`
    ...
    private createLambdaAlarms(fn: lambda.Function): void {
        ...
        new cloudwatch.Alarm(this, `${fn.node.id}ConcurrencyAlarm`, {
            ...
            threshold: fn.reservedConcurrentExecutions
                ? fn.reservedConcurrentExecutions * 0.9
                : 900,
            evaluationPeriods: 1,
...
export class EventMonitoring extends Construct {
    constructor(
        ...
        const bus =
            props.eventBus ||
            events.EventBus.fromEventBusName(this, 'DefaultBus', 'default')
        ...
        submissionEvents.addTarget(
            new targets.LambdaFunction(this.createMetricsFunction())
        )
    }
...
export class MalwareProtectionPlan extends Construct {
    ...
    constructor(
        scope: Construct,
        id: string,
        props: MalwareProtectionPlanProps
    ) {
        super(scope, id)
...
export class GuardDutyMalwareProtectionStackRefactored extends BaseStack {
    protected defineResources(
        props: GuardDutyMalwareProtectionStackProps
    ): void {
        // 1. Detector management
        this.detectorManager = new GuardDutyDetectorManager(
            this,
            'DetectorManager',
            {
                stage: this.stage,
        ...
        // 2. IAM role
        this.malwareProtectionRole = new MalwareProtectionRole(
            this,
            'MalwareRole',
            {
                stage: this.stage,
        ...
        // 5. Event processing
        this.scanEventProcessor = new ScanEventProcessor(
            this,
            'EventProcessor',
            {
                stage: this.stage,
        ...
        if (props.enableRescanCapability) {
            this.rescanCapability = new RescanCapability(
                this,
                'RescanCapability',
                {
                    stage: this.stage,
...
const createLambda = (name: string, config: LambdaConfig): lambda.Function => {
    return new lambda.Function(this, name, {
        ...
        memorySize: config.memory
            ? LAMBDA_MEMORY[config.memory]
            : LAMBDA_MEMORY.MEDIUM,
    })
}
```
...
this.function = new NodejsFunction(this, 'Function', {
    functionName: ResourceNames.resourceName(
        props.serviceName,
        props.functionName,
        props.stage
    ),
                        ...
                        bundling: {
                            ...
                            command: [
                                ...
                                [
                                    ...
                                    props.stage === 'prod' &&
                                        'rm -rf /asset-output/static/js/*.js.map',
                                ]
                                    .filter(Boolean)
                                    .join(' && '),
                            ],
                            ...
                            local: {
                                ...
                                tryBundle(outputDir: string): boolean {
                                    if (
                                        process.env.CDK_DOCKER_BUILD === 'false'
                                    ) {
                                        execSync(
                                            `cd ${path.join(__dirname, '../../../app-web')} && npm ci && npm run build`
                                        )
                                        execSync(
                                            `cp -r ${path.join(__dirname, '../../../app-web/build/*')} ${outputDir}/`
                                        )
                                        if (props.stage === 'prod') {
                                            execSync(
                                                `rm -rf ${outputDir}/static/js/*.js.map`
                                            )
                                        }
                                        return true
                                    }
...
if (props.stage === 'dev') {
    ...
    distribution.defaultBehavior.cachePolicy =
