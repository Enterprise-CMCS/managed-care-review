...
# =============================================================================
# Comprehensive Cypress Testing Script for CDK Dev Environment
# Tests ALL application functionality against CDK-deployed infrastructure
# =============================================================================
...
show_usage() {
    cat << EOF
${CYAN}Comprehensive Cypress Testing for CDK Dev Environment${NC}
...
main() {
    ...
    log_section "CDK Cypress Testing - Dev Environment"
