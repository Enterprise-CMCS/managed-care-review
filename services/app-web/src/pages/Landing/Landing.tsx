...
export const Landing = (): React.ReactElement => {
    ...
    const eqroFlag: boolean = ldClient?.variation(
                        ...
                        <Grid row gap className="margin-top-2">
                                ...
                                <div className={styles.detailsSteps}>
                                    ...
                                    <ul>
                                        <li className={styles.login}>
                                            ...
                                            <span>
                                                Sign in using your IDM
                                                credentials.
                                            </span>
                                        </li>
                                        <li className={styles.upload}>
                                            <span>
                                                Fill out form and upload
                                                documents
                                            </span>
                                            <span>
                                        ...
                                        <li className={styles.email}>
                                            ...
                                            <span>
                                                After you submit, CMS will
                                                confirm receipt and start their
                                                review process.
                                            </span>
                                        </li>
                                    </ul>
                            ...
                            <Grid tablet={{ col: 6 }}>
                                ...
                                <ol className={styles.detailsList}>
                                    <li>
                                        Medicaid and CHIP managed care health
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                Contracts related to Dual
                                                Eligible Special Needs Plans
                                                (D-SNPs) with Medicaid-covered
                                                benefits
                                            </li>
                                            <li>
                                                <LinkWithLogging
                                ...
                                <ol className={styles.detailsList}>
                                    <li>
                                        ...
                                        health plan submissions, including
                                        <ul>
                                            <li>
                                                Contracts without
                        ...
                        <Grid row gap className="margin-top-2">
                            ...
                            <Grid tablet={{ col: 6 }}>
                                ...
                                <ul className={styles.detailsList}>
                                    ...
                                    <li>
                                        Rate certifications and rate amendments
                                    </li>
                                    <li>
                                ...
                                <ul className={styles.detailsList}>
                                    ...
                                    <li>
                                        Non-health plan submissions such as
                                        External Quality Review Organization
                                        (EQRO) or enrollment broker
                                    </li>
                                </ul>
                            </Grid>
                        </Grid>
