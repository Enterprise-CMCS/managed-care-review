...
export type StateIconProps = {
    code: 'FL' | 'IN' | 'MN' | 'MS' | 'VA' | 'AS' | 'AK' | 'AL' | 'AR' | 'AZ' | 'CA' | 'CO' | 'CT' | 'DC' | 'DE' | 'GA' | 'HI' | 'IA' | 'ID' | 'IL' | 'KS' | 'LA' | 'MA' | 'MD' | 'ME' | 'MI' | 'MO' | 'MT' | 'NC' | 'ND' | 'NE' | 'NH' | 'NJ' | 'NM' | 'NV' | 'NY' | 'OH' | 'OK' | 'OR' | 'PA' | 'PR' | 'RI' | 'SC' | 'SD' | 'TN' | 'TX' | 'UT' | 'VT' | 'WA' | 'WI' | 'WV' | 'WY'
}
