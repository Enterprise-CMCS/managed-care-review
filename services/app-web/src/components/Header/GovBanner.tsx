...
// TO BE REPLACED BY REACT-USWDS component soon
    ...
    switch (language) {
        case 'english':
            return {
                ...
                tldSectionContent: ((): JSX.Element => {
                    switch (tld) {
                        case '.gov':
                            return (
                                <>
                                    A <strong>.gov</strong> website belongs to
                                    an official government organization in the
                                    United States.
                                </>
                            )
                        case '.mil':
                            return (
                                <>
                                    A <strong>.mil</strong> website belongs to
                                    an official U.S. Department of Defense
                                    organization.
                                </>
                            )
                    }
                ...
                httpsSectionContent: (
                    <>
                        A <strong>lock ({lock})</strong> or{' '}
                        <strong>https://</strong> means you’ve safely connected
                        to the {tld} website. Share sensitive information only
        ...
        case 'spanish':
            return {
                ...
                tldSectionContent: ((): JSX.Element => {
                    switch (tld) {
                        case '.gov':
                            return (
                                <>
                                    Un sitio web <strong>.gov</strong> pertenece
                                    a una organización oficial del Gobierno de
                                    Estados Unidos.
                                </>
                            )
                        case '.mil':
                            return (
                                <>
                                    Un sitio web <strong>.mil</strong> pertenece
                                    a una organización oficial del Departamento
                                    de Defensa de EE. UU.
                                </>
                            )
                    }
                ...
                httpsSectionContent: (
                    <>
                        Un <strong>candado ({lock})</strong> o{' '}
                        <strong>https://</strong> significa que usted se conectó
                        de forma segura a un sitio web {tld}. Comparta
