...
import { ContractDetailsSummaryCard } from '..'
import { mockContractAndRatesDraft } from '../../../testHelpers/apolloHelpers'

export default {
    title: 'Components/SubmissionSummaryCard/ContractDetailsSummaryCard',
    component: ContractDetailsSummaryCard,
    parameters: {
        componentSubtitle:
...
const Template: Story<SubmissionSummaryCardProps> = (args) => (
    <ContractDetailsSummaryCard {...args} />
)
