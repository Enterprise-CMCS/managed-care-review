...
describe('_DatePicker component', () => {
    ...
    it('renders a toggle button', () => {
        const { getByTestId } = renderDatePicker()
        expect(getByTestId('date-picker-button')).toBeInstanceOf(
            HTMLButtonElement
        )
    ...
    it('renders a hidden calendar dialog element', () => {
        const { getByTestId } = renderDatePicker()
        expect(getByTestId('date-picker-calendar')).toBeInstanceOf(
            HTMLDivElement
        )
    ...
    it('renders a screen reader status element', () => {
        ...
        expect(getByTestId('date-picker-status')).toHaveAttribute(
            'role',
            'status'
        )
    ...
    describe('toggling the calendar', () => {
        ...
        it('shows the calendar when the toggle button is clicked and focuses on the selected date', async () => {
            ...
            expect(getByTestId('date-picker')).toHaveClass(
                'usa-date-picker--active'
            )
        ...
        it('focus defaults to today if there is no value', async () => {
            ...
            const todayLabel = `${todayDate.getDate()} ${
                ...
                DAY_OF_WEEK_LABELS[todayDate.getDay()]
            }`
    ...
    describe('validation', () => {
        it('entering an empty value is valid', async () => {
            ...
            expect(externalInput.validationMessage).toBe('')
        })
