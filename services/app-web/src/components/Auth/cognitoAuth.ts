...
type AmplifyErrorCodes = 'UsernameExistsException' | 'ExpiredCodeException' | 'UserNotConfirmedException' | 'NotAuthorizedException'
...
export async function signUp(user: newUser): Promise<Result<CognitoUser, AmplifyError>> {
	try {
...
export async function confirmSignUp(email: string, code: string): Promise<Result<null, AmplifyError>> {
...
export async function resendSignUp(email: string): Promise<Result<null, AmplifyError>> {
	try {
...
export async function signIn(email: string, password: string): Promise<Result<CognitoUser, AmplifyError>> {
