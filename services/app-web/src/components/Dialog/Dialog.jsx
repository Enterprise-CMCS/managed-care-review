...
export class Dialog extends React.PureComponent {
  ...
  render() {
    ...
    const dialogClassNames = classNames(
      ...
      styles['ds-base'],
      className,
      size && styles[`ds-c-dialog--${size}`]
    );
    const headerClassNames = classNames(styles['ds-c-dialog__header'], headerClassName);
    const actionsClassNames = classNames(styles['ds-c-dialog__actions'], actionsClassName);
    ...
    return (
      <AriaModal
        ...
        underlayClass={styles["ds-c-dialog-wrap"]}
        {...modalProps}
      >
        <div role="document">
          <header ref={(ref) => (this.headingRef = ref)} className={headerClassNames} role="banner">
            {
              ...
              (title || heading) && (
                <h1 className={styles["ds-h2"]} id="dialog-title">
                  {heading}
                </h1>
              )
            }
