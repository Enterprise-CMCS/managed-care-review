...
describe('unlockedWithALittleBitOfEverything migration', () => {
    it('version 2022-08-15 matches the expected values', async () => {
        ...
        // add_one_month
        expect(formData.contractDateStart).toBe(
            '2021-05-22'
        )
        expect(formData.contractDateEnd).toBe(
            '2022-05-21'
        )
        expect(formData.rateDateStart).toBe(
            '2021-05-22'
        )
        expect(formData.rateDateEnd).toBe(
            '2022-04-29'
        )
        expect(formData.rateDateCertified).toBe(
            '2021-05-23'
        )
        expect(
