...
function unlockedWithALittleBitOfEverything(): UnlockedHealthPlanFormDataType {
    return {
        ...
        contractType: 'AMENDMENT',
        contractExecutionStatus: 'UNEXECUTED',
        contractDateStart: '2021-05-22',
        contractDateEnd: '2022-05-21',
        contractDocuments: [],
        contractAmendmentInfo: {
            modifiedProvisions: {
        ...
        rateDateStart: '2021-05-22',
        rateDateEnd: '2022-04-29',
        rateDateCertified: '2021-05-23',
        rateAmendmentInfo: {
            effectiveDateStart: '2022-06-21',
            effectiveDateEnd: '2022-10-21',
        },
        rateProgramIDs: [mockMNState().programs[0].id],
        stateContacts: [
            {
