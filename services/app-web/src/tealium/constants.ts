...
const TEALIUM_CONTENT_TYPE_BY_ROUTE: Record<RouteT | 'UNKNOWN_ROUTE', string> =
    {
        ...
        SUBMISSIONS_ADMIN_UPLOAD_CONTRACT_QUESTION: 'form',
        SUBMISSIONS_ADMIN_UPLOAD_CONTRACT_RESPONSE: 'form',
        SUBMISSIONS_UPLOAD_CONTRACT_RESPONSE: 'form',
        SUBMISSIONS_UPLOAD_RATE_RESPONSE: 'form',
        SUBMISSIONS_DELETE_CONTRACT_QUESTION: 'form',
        SUBMISSIONS_DELETE_CONTRACT_QUESTION_RESPONSE: 'form',
        SUBMISSIONS_RELEASED_TO_STATE: 'form',
        SUBMISSION_WITHDRAW: 'form',
        UNDO_SUBMISSION_WITHDRAW: 'form',
        UNDO_SUBMISSION_UNLOCK: 'form',
        UNDO_SUBMISSION_APPROVAL: 'form',
        UNKNOWN_ROUTE: '404',
    }
