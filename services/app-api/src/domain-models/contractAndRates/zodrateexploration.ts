...
const ZodContractFormDataV1 = ZodContractFormDataV0.merge(
    z.object({
...
const ZodContractFormDataV2 = ZodContractFormDataV1.merge(
    z.object({
...
const ModifiedProvisionsV1 = ModifiedProvisionsV0.merge(
    z.object({
        modifiedPassThroughPayments: z.boolean(),
    })
)

const ZodContractFormDataV3 = ZodContractFormDataV1.merge(
    z.object({
...
type ZodContractFormDataTypeVCurrent = z.infer<
    typeof ZodContractFormDataVCurrent
>

const ZodDraftContractFormData = ZodContractFormDataVCurrent.merge(
    z.object({
...
const ZodContractRevisionDraft = ZodContractRevision.merge(
    z.object({
...
const ZodRateFormDataV0 = z.intersection(
    ZodBaseRateFormData,
    z.discriminatedUnion('rateType', [
        ZodRateAmendmentFormData,
        ZodNewRateAmendmentFormDataV0,
    ])
)
type ZodRateFormDataTypeV0 = z.infer<typeof ZodRateFormDataV0>

const ZodNewRateAmendmentFormDataV1 = ZodNewRateAmendmentFormDataV0.merge(
    z.object({
        exactStartDate: z.date(),
    })
)

const ZodRateFormDataV1 = z.intersection(
    ZodBaseRateFormData,
    z.discriminatedUnion('rateType', [
        ZodRateAmendmentFormData,
        ZodNewRateAmendmentFormDataV1,
    ])
)
