...
import {
    ...
    findRateRevision,
    findSubmissionDiffByContractID,
    approveContract,
...
type Store = {
    ...
    findSubmissionDiffByContractID: (args: {
        contractID: string
...
function NewPostgresStore(client: ExtendedPrismaClient): Store {
    return {
        ...
        findSubmissionDiffByContractID: (args) =>
            findSubmissionDiffByContractID(client, args),
        ...
        overrideContractData: (args) => overrideContractData(client, args),
