...
import type { DocumentZipType, DocumentZipPackage } from '@mc-review/database'
import type { ExtendedPrismaClient } from '../prismaClient'
import type { User } from '@mc-review/database'
...
describe('Document Zip Package Database Functions', () => {
    ...
    describe('createDocumentZipPackage', () => {
        ...
        it('successfully creates zip package with minimal required fields', async () => {
            ...
            // All fields are actually optional except s3URL, sha256, and documentType
