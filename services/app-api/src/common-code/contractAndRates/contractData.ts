...
import type { ContractType, UnlockedContractType, ContractRevisionType, ContractPackageSubmissionType } from '../../domain-models'
import {
    CHIPProvisionType,
...
const getLastContractSubmission = (contract: ContractType | UnlockedContractType): ContractPackageSubmissionType | undefined => {
    return (contract.packageSubmissions && contract.packageSubmissions[0]) ?? undefined
}
const getContractRev = (contract: ContractType | UnlockedContractType): ContractRevisionType | undefined => {
