import { Resolver, ResolverTypeWrapper,  CreateDraftSubmissionInput, CreateDraftSubmissionPayload} from '../gen/gqlServer'

// eslint-disable-next-line @typescript-eslint/ban-types, @typescript-eslint/no-explicit-any
  export const createDraftSubmissionResolver:  Resolver<ResolverTypeWrapper<CreateDraftSubmissionPayload>, {}, CreateDraftSubmissionInput, {}> = async (_parent, { input}, context) => {
