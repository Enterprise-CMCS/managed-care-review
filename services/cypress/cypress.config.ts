    ...
    e2e: {
        ...
        setupNodeEvents(on, config) {
            ...
            newConfig.env.COGNITO_USER_POOL_ID =
                process.env.VITE_APP_COGNITO_USER_POOL_ID
            newConfig.env.COGNITO_REGION = process.env.VITE_APP_COGNITO_REGION
            newConfig.env.COGNITO_IDENTITY_POOL_ID =
                process.env.VITE_APP_COGNITO_ID_POOL_ID
            newConfig.env.COGNITO_USER_POOL_WEB_CLIENT_ID =
                process.env.VITE_APP_COGNITO_USER_POOL_CLIENT_ID
            on('before:browser:launch', (browser, launchOptions) => {
