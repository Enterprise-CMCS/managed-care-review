...
function mockEqroContractSubmittedUnderReview(
    partial?: Partial<Contract>
): Contract {
    const contractID = partial?.id ?? 'ad66b22d-3323-45f9-8129-4afd4f1da7da'
    ...
    return {
        ...
        reviewStatus: 'UNDER_REVIEW',
        consolidatedStatus: 'SUBMITTED',
        createdAt: '2026-03-23T16:34:52.864Z',
        updatedAt: '2026-03-23T16:34:52.864Z',
        webURL: `http://localhost:3000/submissions/eqro/${contractID}`,
        initiallySubmittedAt: '2026-03-23T16:35:27.729Z',
        lastUpdatedForDisplay: '2026-03-23T16:35:27.793Z',
        ...
        packageSubmissions: [
            {
                ...
                submitInfo: {
                    __typename: 'UpdateInformation',
                    updatedAt: '2026-03-23T16:35:27.729Z',
                    updatedBy: {
                        __typename: 'UpdatedBy',
                ...
                submittedRevisions: [
                    {
                        __typename: 'ContractRevision',
                        id: '0dbdd00b-a196-4ca0-a812-2526bf6a757b',
                        createdAt: '2026-03-23T16:34:52.864Z',
                        updatedAt: '2026-03-23T16:35:27.733Z',
                        contractID,
                        contractName: 'MCR-MN-0003-SNBC',
                        submitInfo: {
                            __typename: 'UpdateInformation',
                            updatedAt: '2026-03-23T16:35:27.729Z',
                            updatedBy: {
                        ...
                        documentZipPackages: [
                            {
                                ...
                                downloadUrl:
                                    'http://localhost:4566/fake-zip-download-url',
                            },
                        ],
                    },
                ],
                contractRevision: {
                    ...
                    formData: {
                        ...
                        dsnpContract: null,
                        riskBasedContract: null,
                        submissionDescription: 'Subject To Review submission',
                        stateContacts: [
                            {
                                __typename: 'StateContact',
                                name: 'anne smith',
...
function mockEqroContractSubmittedNotSubjectToReview(
    partial?: Partial<Contract>
): Contract {
    const contractID = partial?.id ?? 'ef95d436-36ed-474b-831d-95887e5aafbf'
    ...
    return {
        ...
        createdAt: '2026-03-23T17:01:08.048Z',
        updatedAt: '2026-03-23T17:01:08.048Z',
        webURL: `http://localhost:3000/submissions/eqro/${contractID}`,
        initiallySubmittedAt: '2026-03-23T17:01:31.902Z',
        lastUpdatedForDisplay: '2026-03-23T17:01:31.968Z',
        dateContractDocsExecuted: null,
        stateCode: 'MN',
        contractSubmissionType: 'EQRO',
        mccrsID: null,
        reviewStatusActions: [
            {
                __typename: 'ContractReviewStatusActions',
                updatedAt: '2026-03-23T17:01:31.968Z',
                updatedBy: null,
                dateApprovalReleasedToState: null,
                updatedReason: null,
                contractID,
        ...
        packageSubmissions: [
            {
                ...
                submitInfo: {
                    __typename: 'UpdateInformation',
                    updatedAt: '2026-03-23T17:01:31.902Z',
                    updatedBy: {
                        __typename: 'UpdatedBy',
                        email: 'aang@example.com',
                        role: 'STATE_USER',
                ...
                submittedRevisions: [
                    {
                        __typename: 'ContractRevision',
                        id: 'ceec98af-7808-4956-9e23-59a76314a308',
                        createdAt: '2026-03-23T17:01:08.048Z',
                        updatedAt: '2026-03-23T17:01:31.905Z',
                        contractID,
                        contractName: 'MCR-MN-0001-SNBC',
                        submitInfo: {
                            __typename: 'UpdateInformation',
                            updatedAt: '2026-03-23T17:01:31.902Z',
                            updatedBy: {
                        ...
                        formData: {
                            ...
                            riskBasedContract: null,
                            submissionDescription:
                                'Submission that will be not subject to review',
                            stateContacts: [
                                {
                                    __typename: 'StateContact',
                                    name: 'anne smith',
...
function mockEqroContractResubmittedWithReviewStatusChange(
    partial?: Partial<Contract>
): Contract {
    const contractID = partial?.id ?? 'ef95d436-36ed-474b-831d-95887e5aafbf'
    ...
    return {
        ...
        webURL: `http://localhost:3000/submissions/eqro/${contractID}`,
        initiallySubmittedAt: '2026-03-23T17:01:31.902Z',
        lastUpdatedForDisplay: '2026-03-23T17:10:31.209Z',
        dateContractDocsExecuted: null,
        stateCode: 'MN',
        contractSubmissionType: 'EQRO',
        mccrsID: null,
        reviewStatusActions: [
            {
                __typename: 'ContractReviewStatusActions',
                updatedAt: '2026-03-23T17:10:31.209Z',
                updatedBy: null,
                dateApprovalReleasedToState: null,
                updatedReason: null,
                contractID,
        ...
        packageSubmissions: [
            {
                ...
                submitInfo: {
                    __typename: 'UpdateInformation',
                    updatedAt: '2026-03-23T17:10:31.154Z',
                    updatedBy: {
                        __typename: 'UpdatedBy',
                        email: 'aang@example.com',
                        role: 'STATE_USER',
                ...
                submittedRevisions: [
                    {
                        __typename: 'ContractRevision',
                        id: '3b09d953-1256-4fb5-8406-20d0e007be17',
                        createdAt: '2026-03-23T17:09:40.003Z',
                        updatedAt: '2026-03-23T17:10:31.155Z',
                        contractID,
                        contractName: 'MCR-MN-0001-SNBC',
                        submitInfo: {
                            __typename: 'UpdateInformation',
