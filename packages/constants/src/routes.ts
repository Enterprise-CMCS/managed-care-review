...
const ROUTES = [
    ...
    'SUBMISSIONS',
    'SUBMISSIONS_NEW',
    'SUBMISSIONS_NEW_HEALTH_PLAN',
    'SUBMISSIONS_NEW_EQRO',
    'SUBMISSIONS_TYPE',
...
const RoutesRecord: Record<RouteT, string> = {
    ...
    SUBMISSIONS_NEW_HEALTH_PLAN: '/submissions/new/health-plan',
    SUBMISSIONS_NEW_EQRO: '/submissions/new/eqro',
...
const PageTitlesRecord: Record<RouteT | 'UNKNOWN_ROUTE', string> = {
    ...
    SUBMISSIONS_NEW_HEALTH_PLAN: 'New health plan submission',
    SUBMISSIONS_NEW_EQRO: 'New EQRO submission',
