...
const RoutesRecord = {
    ...
    SUBMISSIONS_UPLOAD_QUESTION: '/submissions/:id/question-and-answers/:division/upload-questions',
    SUBMISSIONS_UPLOAD_RESPONSE: '/submissions/:id/question-and-answers/:division/:questionID/upload-response',
};
...
const STATE_SUBMISSION_SUMMARY_ROUTES = [
    'SUBMISSIONS_SUMMARY',
    'SUBMISSIONS_REVISION',
];
const QUESTION_RESPONSE_SHOW_SIDEBAR_ROUTES = [
    'SUBMISSIONS_QUESTIONS_AND_ANSWERS',
    'SUBMISSIONS_SUMMARY',
    'SUBMISSIONS_TYPE',
    'SUBMISSIONS_CONTRACT_DETAILS',
