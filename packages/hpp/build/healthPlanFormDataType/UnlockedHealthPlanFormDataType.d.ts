...
type ActuarialFirmType = 'MERCER' | 'MILLIMAN' | 'OPTUMAS' | 'GUIDEHOUSE' | 'DELOITTE' | 'STATE_IN_HOUSE' | 'OTHER';
...
export type { SubmissionType, SubmissionDocument, RateType, StateContact, ActuaryContact, ActuarialFirmType, ActuaryCommunicationType, ContractType, ManagedCareEntity, UnlockedHealthPlanFormDataType, ContractAmendmentInfo, ContractExecutionStatus, RateCapitationType, RateInfoType, SharedRateCertDisplay, PopulationCoveredType, };
