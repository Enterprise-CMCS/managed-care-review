...
function newHealthPlanFormData() {
    return {
...
function basicHealthPlanFormData() {
    return {
        createdAt: new Date(Date.UTC(2021, 4, 10)),
        updatedAt: new Date(),
        status: 'DRAFT',
        ...
        rateInfos: [
            {
                ...
                rateCertificationName: 'MCR-MN-0005-SNBC-RATE-20220621-20221021-AMENDMENT-20210523',
                rateDocuments: [],
                supportingDocuments: [],
                actuaryContacts: [
                    {
...
function unlockedWithDocuments() {
    return {
        createdAt: new Date(Date.UTC(2021, 4, 10)),
        updatedAt: new Date(),
        status: 'DRAFT',
...
function unlockedWithFullRates() {
    return {
        createdAt: new Date(Date.UTC(2021, 4, 10)),
        updatedAt: new Date(),
        status: 'DRAFT',
...
function unlockedWithFullContracts() {
    return {
        createdAt: new Date(Date.UTC(2021, 4, 10)),
        updatedAt: new Date(),
        status: 'DRAFT',
...
function unlockedWithALittleBitOfEverything() {
    return {
        id: 'test-abc-123',
        createdAt: new Date(Date.UTC(2021, 4, 10)),
...
function basicLockedHealthPlanFormData() {
    return {
        createdAt: new Date(Date.UTC(2021, 4, 10)),
        updatedAt: new Date(),
