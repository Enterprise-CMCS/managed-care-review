...
import { basicLockedHealthPlanFormData, basicHealthPlanFormData, unlockedWithALittleBitOfEverything, } from '../healthPlanFormDataMocks';
import { domainToBase64, protoToBase64 } from '../proto/healthPlanFormDataProto';
import { mockMNState } from './stateMock';
function mockDraft(partial) {
    return {
        status: 'DRAFT',
        stateNumber: 5,
        createdAt: new Date(),
...
function mockBaseContract(partial) {
    return {
        status: 'DRAFT',
        stateNumber: 5,
        createdAt: new Date(),
...
function mockContractAndRatesDraft(partial) {
    return {
        status: 'DRAFT',
        stateNumber: 5,
        createdAt: new Date(),
...
function mockStateSubmissionContractAmendment() {
    return {
        status: 'SUBMITTED',
        stateNumber: 5,
        createdAt: new Date(),
...
function mockDraftHealthPlanPackage(submissionData) {
...
function mockSubmittedHealthPlanPackage(submissionData, submitInfo) {
...
function mockSubmittedHealthPlanPackageWithRevisions() {
    // get a submitted DomainModel submission
    // turn it into proto
...
function mockUnlockedHealthPlanPackage(submissionData, unlockInfo) {
    const submission = {
...
function mockUnlockedHealthPlanPackageWithOldProtos(unlockedWithOldProto) {
...
function mockUnlockedHealthPlanPackageWithDocuments() {
    // SETUP
...
//# sourceMappingURL=healthPlanFormDataMock.js.map