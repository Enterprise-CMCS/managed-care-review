import { mockBaseContract, mockContractAndRatesDraft, } from '../testHelpers/healthPlanFormDataMock';
import { modifiedProvisionMedicaidAmendmentKeys, modifiedProvisionMedicaidBaseKeys, provisionCHIPKeys, } from '../healthPlanFormDataType/ModifiedProvisions';
import { generateApplicableProvisionsList, sortModifiedProvisions, } from './provisions';
describe('generateApplicableProvisionsList', () => {
    ...
    test.each(submissionsAndSupportedProvisions)('given %o as a submission, returns %p as the list of supported provisions', (firstArg, expectedResult) => {
...
//# sourceMappingURL=provisions.test.js.map